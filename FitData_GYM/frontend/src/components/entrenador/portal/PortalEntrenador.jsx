...
function PortalEntrenador() {
  /** maestro funciona asi la extraccion */
  const { pestañaActiva, setPestañaActiva, cerrarSesion } = usePortalEntrenador();

  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 text-white p-4 md:p-8">
      <BarraNavegacionEntrenador pestañaActiva={pestañaActiva} onCambiarPestaña={setPestañaActiva} onCerrarSesion={cerrarSesion} />
