...
function PanelMenu({ title, description, accentClass, titleClass, options, maxWidth = 'max-w-2xl', onNavigate }) {
  return (
    <div className="flex w-full justify-center">
      <div className={`relative w-full ${maxWidth} overflow-hidden rounded-xl border border-slate-700 bg-gray-800 p-8 shadow-2xl`}>
